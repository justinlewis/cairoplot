...
Goal for this branch:
	...
	The goal is to allow custom formatting of bar chart labels.  For example, adding % to a the label above each bar. Michael Rooney has achieved this on 
a previous version of Cairoplot but the changes where never merged with the master branch. This fork will attempt to incorporate the changes made by Michael Rooney.  
...
About Cairoplot:
	...
	CairoPlot is a Python based charting library created and maintained by Rodrigo Araújo (https://github.com/rodrigoaraujo01).  
